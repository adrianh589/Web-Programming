...
public class cambioDeContrasena extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String antiguaContraseña = request.getParameter("oldpw");
        String nuevaContraseña = request.getParameter("pw");
        
        System.out.println(antiguaContraseña);
        ...
        if(antiguaContraseña.equals(usuarioActual.getContraseña())) {
